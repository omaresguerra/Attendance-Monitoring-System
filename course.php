...
<html>
<head>
  <title>Course-Attendance Monitoring System</title>
        ...
        <!-- <div class="table-attendance"> -->
          ...
          <div class="table-record">
              <div class="record">
                ...
                $query = "SELECT * FROM course JOIN department ON department.DeptID=course.DeptID GROUP BY CourseID ASC";

                echo "<table cellpadding=9 cellspacing=0 border=0>";

                $result = mysqli_query($dbcon, $query);
                  echo "<tr>";
                  echo "<td class=head><b>CourseID</b></td>";
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  if ($acctype =='Admin') {
                     echo "<td><a href=edit.php?id=".$row['CourseID']."&acctype=".$acctype."&tb=Course><img src=img/edit.png class=edit1></a></td>";
                  }
                  echo "</tr>";
                }
                echo "</table>";
          ...
          <div class="table-record">
              <div class="record">
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  echo "<td>".$row['CourseName']."</td>";
                  echo "<td>".$row['DeptName']."</td>";
                  echo "<td><a href=delete.php?id=".$row['CourseID']."&acctype=".$acctype."&tb=Course><img src=img/delete.png class=edit2></a></td>";
                  echo "</tr>";
                }
                echo "</table>";
              ?>
...
<?php } ?>
  <div class="form-attendance-attend">
       ...
       <div class="attend-view">
            <div class="attend1">
              <img src="img/course-view.png" class="img-home-attend">
            </div>
            <div class="attend2">
              <button class="button-home" onclick="document.getElementById('id02').style.display='block'">View Course</button>
            </div>
       </div>
       <?php 
           $acctype = $_GET['acctype'];
       ...
       <div class="student-view">
          <div class="attend1">
            <img src="img/course-add.png" class="img-home-attend">
          </div>
          <div class="attend2">
            <button class="button-home" onclick="document.getElementById('id03').style.display='block'">Add Course</button>
          </div>
       </div>
       <div class="student-view">
          <div class="attend1">
            <img src="img/course-del.png" class="img-home-attend">
          </div>
          <div class="attend2">
            <button class="button-home-attend" onclick="document.getElementById('id04').style.display='block'">Delete Course</button>
          </div>
       </div>
       <?php 
         }
     ...
     <div id="id03" class="modal-insert-course">
      <div class="modal-1">
       ...
       <?php
        ...
        echo "<form action=insert.php?acctype=".$acctype."&tb=Course method=POST class=modal-content animate>";
       ?>
          <div class="imgcontainer-student">
            <img src="img/course-add-1.png" alt="Avatar" class="avatar-student">
          </div>
          <div class="container">
           
            <label><b>CourseName</b></label>
            <input type="text" name="txtCourseName" class="select1" placeholder="Enter CourseName" required="">
            <label><b>Department</b></label>
                 <?php 
                    include('config.php');
                    $query = "SELECT * FROM department";
                    $result = mysqli_query($dbcon, $query);
                    echo "<select class=select1 name='cboxDepartment' onmousedown='if(this.options.length>4){this.size=4;}'   onchange='this.size=0;' onblur='this.size=0;'>";
                      while ($row = mysqli_fetch_array($result)) {
                        echo "<option value='".$row['DeptID']."'>".$row['DeptName']."</option>";
                      }
                    echo "</select>";
                 ?>
            <button type="submit" onclick="document.getElementById('id02').style.display='action'">Add Course</button> 
          </div>
