          ...
          <div class="imgcontainer">
            <img src="img/attendance2.png" alt="Avatar" class="avatar">
                ...
                if (empty($_POST['name'])&& empty($_POST['address'])) {
                    $query0A = "SELECT DeptName FROM department
                      WHERE DeptID = $dept";
                    ...
                    while ($row0A=mysqli_fetch_array($result0A)) {
                        $acct0A = $row0A['DeptName'];
                        echo "$acct0A";
                    } 
                    echo "</div>
                    <div class=update>
                    <b style=color:#f00;>**StudName & Address is empty!</b>
                    </div>";
                }
                elseif (empty($_POST['name'])) {
                    ...
                    echo "</div>
                    <div class=update>
                    <b style=color:#f00;>**StudName is empty!</b>
                    </div>";
                }
                elseif (empty($_POST['address'])) {
                    ...
                    echo "</div>
                    <div class=update>
                    <b style=color:#f00;>**Address is empty!</b>
                    </div>";
                }
                else{
                    $query = "UPDATE student SET StudID='".$studid."', StudName='".$name."', Address='".$address."', DeptID='".$dept."' WHERE StudID='".$studid."'";
