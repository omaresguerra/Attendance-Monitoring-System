   ...
   <div class="modal">
        <div class="modal-content">
          ...
          <?php
              ...
              echo "<form class=container action=update-department.php?acctype=".$acctype." method=POST>";
               
               while ($row = mysqli_fetch_array($result)) {
                     echo "<label><b>DeptID</b></label>";
                     echo "<div class=hide></div>";
                     echo "<input class=input type='text' name='id' value='".$row['DeptID']."'>";
                     echo "<label><b>StudentName</b></label>";
                     echo "<input class=input type='text' name='deptname' value='".$row['DeptName']."'>";
